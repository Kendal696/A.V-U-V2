                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          openEditDialog(context, documentId, name, description, date, imageUrl);
                        },
                      ),
                      IconButton(
...
void openEditDialog(BuildContext context, String documentId, String name, String description, Timestamp date, String imageUrl) {
  String newName = name;
