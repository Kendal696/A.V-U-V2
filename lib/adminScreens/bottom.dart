...
class BottomAdmin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      home: BottomAdminScreen(),
    );
  }
}

class BottomAdminScreen extends StatefulWidget {
  const BottomAdminScreen({super.key});

  @override
  State<BottomAdminScreen> createState() =>
      _BottomAdminScreenState();
}


class _BottomAdminScreenState
    extends State<BottomAdminScreen> {
